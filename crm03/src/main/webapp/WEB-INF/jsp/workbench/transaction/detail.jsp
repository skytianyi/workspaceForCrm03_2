...
<script type="text/javascript">
	...
	function chageStage(stage,i) {

		$.ajax({

			url : "workbench/transaction/chageStage.do",
			data : {
				"stage":stage,
				"id":"${t.id}",
				"money":"${t.money}",
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<span id="<%=i%>" onclick="chageStage('<%=listStage%>','<%=i%>')" class="glyphicon glyphicon-remove mystage"
		...
		<%
			...
			//如果遍历出来的阶段的可能性不为0	说明遍历出来的是前7个阶段
		}else{

			//黑圈--------------------------------
		%>

		<span id="<%=i%>" onclick="chageStage('<%=listStage%>','<%=i%>')" class="glyphicon glyphicon-record mystage"
			  data-toggle="popover" data-placement="bottom"
			  data-content="<%=listStage%>" style="color: #000000;"></span>
		-----------
		...
		<span id="<%=i%>" onclick="chageStage('<%=listStage%>','<%=i%>')" class="glyphicon glyphicon-map-marker mystage"
			  data-toggle="popover" data-placement="bottom"
		...
		<span id="<%=i%>" onclick="chageStage('<%=listStage%>','<%=i%>')" class="glyphicon glyphicon-ok-circle mystage"
			  data-toggle="popover" data-placement="bottom"
			  data-content="<%=listStage%>" style="color: #90F790;"></span>
		-----------
