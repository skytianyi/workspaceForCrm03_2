...
<body>
	...
	<div style="position:  relative; left: 30px;">
		<h3>创建交易</h3>
	  	<div style="position: relative; top: -40px; left: 70%;">
			<button type="button" class="btn btn-primary" id="tranBtn">保存</button>
	...
	<form class="form-horizontal" id="tranForm" action="workbench/transaction/saveTran.do" method="post" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" autocomplete="off" id="create-customerName" name="customerName" placeholder="支持自动补全，输入客户不存在则新建">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" readonly value="发传单1">
				<input type="hidden" id="activityId" name="activityId" value="7a09970c2aab4e478ed85b4326d06163">
			</div>
		</div>
